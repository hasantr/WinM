...
Gui Add, Text, x184 y8 w156 h23 +0x200, Coord:
Gui Add, Text, x64 y8 w99 h23 +0x200, City
Gui Add, Text, x24 y58 w76 h23 +0x200 , Tolerance: `%
Gui Add, Slider, x24 y82 w120 h23, 50
Gui Add, Text, x104 y58 w30 h23 +0x200 , Text
Gui Add, GroupBox, x8 y34 w156 h77
Gui Add, Text, x200 y58 w76 h23 +0x200 , Tolerance: `%
Gui Add, Text, x280 y58 w31 h23 +0x200 , Text
Gui Add, Slider, x200 y82 w120 h22, 50
Gui Add, GroupBox, x184 y34 w158 h77
Gui Add, Button, x8 y8 w53 h23, Region
Gui Add, CheckBox, x192 y34 w68 h23, Weather
Gui Add, CheckBox, x16 y34 w68 h23, Day Light
...
Gui Add, Button, hWndHDylightSet x312 y42 w26 h23,&
SetButtonIcon(HDylightSet, "wmploc.DLL", 18)
Gui Add, Button,hWndHWethrSet x136 y42 w26 h23,&
...
Gui +hWndhMainWnd
Gui Color, 0xFEFFDD
Gui Add, GroupBox, x8 y120 w335 h107, Brightness:
Gui Font, s13 ;c0xFBFBFB
Gui Add, Text, x172 y144 w85 h23 +0x200 vVBRtext, % Bright
Gui Font
Gui Add, Slider, x16 y173 w321 h44  Line2 Page5 TickInterval3 Range0-100 Thick30 +Center +0x20 Tooltip vVBright  gGBright AltSubmit, % Bright
Gui Add, GroupBox, x8 y240 w336 h108, Temperature:
Gui Font, s13 ;c0xFBFBFB
Gui Add, Text, x162 y264 w60 h23 +0x200 vVTPtext, % Temp
Gui Font
Gui Add, Slider, x16 y296 w321 h43 Line2 Page100 TickInterval180 Range600-5600 Thick30 +Center +0x20 +Tooltip vVTemp  gGTemp AltSubmit, % Temp
Gui Add, CheckBox, x8 y360 h16 gGChecked vVChecked, Control of the edges of the screen.
Gui Add, CheckBox, x200 y360  h16 gGShiftWheel vVShiftWheel,With Shift + Wheel control.
Gui Add, CheckBox, x8 y382  h16 vVAutoStart gGAutoStart, Start at the start of the system.
Gui Add, CheckBox, x200 y382 h16 gGTRYMenuShow vVTRYMenuShow, Show notification area.
...
Gui Add, Button, x290 y402 w50 h26 gSifirla, Reset 

if GuiGoster == 1
	Gui Show, w350 h432, Brightness and Temperature Control
