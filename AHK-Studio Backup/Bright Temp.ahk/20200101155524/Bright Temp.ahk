...
Gui Add, GroupBox, x5 y195 w317 h141
Gui Add, CheckBox, x17 y190 w130 h23, Atmospheric Conditions
Gui Add, Text, x28 y255 w76 h23 +0x200, Tolerance: `%
Gui Add, Slider, x29 y282 w120 h32, 50
Gui Add, Text, x107 y254 w41 h23 +0x200, Text
Gui Add, GroupBox, x15 y229 w145 h97
Gui Add, Text, x174 y256 w76 h23 +0x200, Tolerance: `%
Gui Add, Text, x254 y258 w41 h23 +0x200, Text
Gui Add, Slider, x174 y286 w120 h32, 50
Gui Add, GroupBox, x165 y229 w145 h97
Gui Add, CheckBox, x175 y224 w68 h23, Weather
Gui Add, CheckBox, x27 y223 w68 h23, Day Light
...
Gui +hWndhMainWnd
Gui Color, 0xFEFFDD
Gui Add, GroupBox, x8 y64 w335 h107, Brightness:
Gui Font, s13 ;c0xFBFBFB
Gui Add, Text, x172 y84 w59 h23 +0x200 vVBRtext, % Bright
Gui Font
Gui Add, Slider, x16 y117 w321 h44  Line2 Page5 TickInterval3 Range0-100 Thick30 +Center +0x20 Tooltip vVBright  gGBright AltSubmit, % Bright
Gui Add, GroupBox, x8 y184 w336 h108, Temperature:
Gui Font, s13 ;c0xFBFBFB
Gui Add, Text, x162 y208 w60 h23 +0x200 vVTPtext, % Temp
Gui Font
Gui Add, Slider, x16 y240 w321 h43 Line2 Page100 TickInterval180 Range600-5600 Thick30 +Center +0x20 +Tooltip vVTemp  gGTemp AltSubmit, % Temp
Gui Add, CheckBox, x8 y304  h16 gGChecked vVChecked, Control of the edges of the screen.
Gui Add, CheckBox, x200 y304  h16 gGShiftWheel vVShiftWheel,With Shift + Wheel control.
Gui Add, CheckBox, x8 y326  h16 vVAutoStart gGAutoStart, Start at the start of the system.
Gui Add, CheckBox, x200 y326  h16 gGTRYMenuShow vVTRYMenuShow, Show notification area.
...
Gui Add, Button, x290 y346 w50 h26 gSifirla, Reset 

if GuiGoster == 1
	Gui Show, w350 h376, Brightness and Temperature Control
