...
{	
	GuiGoster := 1
	RegWrite, REG_SZ, HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Run,BrightTempAutoStart,%A_ScriptFullPath% . "\autostart"
...
if(AutoStart == A_ScriptFullPath . "\autostart") ;"\autostart" registry parameters (detect system startup)
