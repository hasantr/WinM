...
Gui +hWndhMainWnd
Gui Color, 0xFEFFDD
Gui Add, GroupBox, x8 y80 w335 h107, Brightness:
Gui Font, s13 ;c0xFBFBFB
Gui Add, Text, x172 y84 w75 h23 +0x200 vVBRtext, % Bright
Gui Font
Gui Add, Slider, x16 y133 w321 h44  Line2 Page5 TickInterval3 Range0-100 Thick30 +Center +0x20 Tooltip vVBright  gGBright AltSubmit, % Bright
Gui Add, GroupBox, x8 y200 w336 h108, Temperature:
Gui Font, s13 ;c0xFBFBFB
Gui Add, Text, x162 y224 w60 h23 +0x200 vVTPtext, % Temp
Gui Font
Gui Add, Slider, x16 y256 w321 h43 Line2 Page100 TickInterval180 Range600-5600 Thick30 +Center +0x20 +Tooltip vVTemp  gGTemp AltSubmit, % Temp
Gui Add, CheckBox, x8 y320  h16 gGChecked vVChecked, Control of the edges of the screen.
Gui Add, CheckBox, x200 y320  h16 gGShiftWheel vVShiftWheel,With Shift + Wheel control.
Gui Add, CheckBox, x8 y342  h16 vVAutoStart gGAutoStart, Start at the start of the system.
Gui Add, CheckBox, x200 y342 h16 gGTRYMenuShow vVTRYMenuShow, Show notification area.
...
Gui Add, Button, x290 y362 w50 h26 gSifirla, Reset 

if GuiGoster == 1
	Gui Show, w350 h392, Brightness and Temperature Control
