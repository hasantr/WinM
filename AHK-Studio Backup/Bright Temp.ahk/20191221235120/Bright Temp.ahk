...
{	
	GuiGoster := 1
	RegWrite, REG_SZ, HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Run,BrightTempAutoStart,%A_ScriptFullPath% . "\systemStartuo"
...
Gui Add, CheckBox, x200 y248  h16 gGTRYMenuShow vVTRYMenuShow, Show notification area.
...
if(AutoStart == A_ScriptFullPath . "\systemStartuo") ;"\autostart" registry parameters (detect system startup)
